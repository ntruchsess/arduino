...
loop()
{
  ...
  stepper.update();
#endif
  // it's save to flush in every loop since there's either no data or a complete firmata msg outstanding.
  PanStream.flush();
}
